...
abstract class ImageViewTouchBase extends ImageView {
    ...
    final protected com.reflektt.reflektt.mikelau.croperino.RotateBitmap mBitmapDisplayed = new com.reflektt.reflektt.mikelau.croperino.RotateBitmap(null);
    ...
    public void setImageBitmapResetBase(final Bitmap bitmap,
        ...
        setImageRotateBitmapResetBase(new com.reflektt.reflektt.mikelau.croperino.RotateBitmap(bitmap), resetSupp);
    }

    public void setImageRotateBitmapResetBase(final com.reflektt.reflektt.mikelau.croperino.RotateBitmap bitmap,
                                              final boolean resetSupp) {
    ...
    private void getProperBaseMatrix(com.reflektt.reflektt.mikelau.croperino.RotateBitmap bitmap, Matrix matrix) {
